...
public class ConfiguredJob extends Job {

	private List<String> inputs;
	private String output;
	private String jobName;
	private int reduceJobs;
	public ConfiguredJob(Configuration conf, String input, String output,
	...
	private void setup() throws IOException {
		...
		setJobName(jobName);
		setJarByClass(ConfiguredJob.class);
	...
	public void run() throws IOException, InterruptedException,
		...
		System.out.println(String.format("Runtime for Job %s: %d", jobName,
				end - start));
	}
}
